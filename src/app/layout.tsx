      ...
      <body className="min-h-full flex flex-col bg-background text-foreground">
        ...
        <div className="fixed bottom-6 right-6 z-50">
          ...
          <a
            ...
            className="relative flex h-14 w-14 items-center justify-center rounded-full shadow-xl transition-transform duration-200 hover:scale-110 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#25D366]/50"
            style={{ background: "#25D366" }}
          >
