  ...
  return (
    ...
    >
      ...
      {p.image && p.instagramHandle ? (
        ...
        <div className="relative w-full overflow-hidden rounded-t-2xl" style={{ height: 300 }}>
          ...
          <div className="absolute top-0 left-0 right-0 z-10 flex items-center gap-2 px-3 py-2.5 bg-white/95 backdrop-blur-sm border-b border-black/[0.07]">
            <div className="w-6 h-6 rounded-full bg-gradient-to-br from-rose-400 to-red-600 flex-shrink-0" />
